...
public class QuantStrategyInitRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        List<QuantStrategyVo> strategies = List.of(
                ...
                strategy("Candle MTF Trend", "CANDLE_MTF_TREND_V2", "Event-driven multi-timeframe candle trend strategy with pattern-based exits and minute gate diagnostics", "STOCK", "EVENT", "{\"topN\":1,\"maxHoldDays\":40,\"entryCadenceDays\":10,\"targetAverageMonthlyReturn\":0.15,\"profitExit\":\"TRAILING_OR_DISTRIBUTION\",\"minuteFallback\":\"NO_MINUTE_DATA\"}")
        );
