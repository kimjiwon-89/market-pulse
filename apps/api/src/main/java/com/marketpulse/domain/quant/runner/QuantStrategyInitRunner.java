...
public class QuantStrategyInitRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        List<QuantStrategyVo> strategies = List.of(
                ...
                strategy("Candle MTF Trend V3 FIN NB", "CANDLE_MTF_TREND_V3_FIN_NB", "Event-driven W4 candle trend candidate with 5-day delayed entry, next-body confirmation, and KOSPI/KOSDAQ MA20 regime", "STOCK", "EVENT", "{\"topN\":10,\"maxHoldDays\":30,\"entryCadenceDays\":5,\"entryDelayDays\":5,\"entryUpperShadow\":0.08,\"nextBodyRet\":0.0,\"stopLoss\":0.18,\"earlyFail\":0.08,\"trailStart\":0.20,\"trailPct\":0.20,\"marketRegime\":\"KOSPI_AND_KOSDAQ_ABOVE_MA20\",\"targetAverageMonthlyReturn\":0.15,\"source\":\"market_daily_price\"}")
        );
