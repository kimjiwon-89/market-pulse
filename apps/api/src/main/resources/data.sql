...
-- 시장 국면 감시 스냅샷 (KOSPI/KOSDAQ intraday monitor)
...
-- Quant 모델 패키지 registry (폴더 감지 + 관리자 노출 제어)
...
('KOSPI_BULL', 'KOSPI Bull v1', '1.0.0', '상승장', 'KOSPI 전용 상승장 paper-shadow 후보 패키지입니다.', 'domains/quant-serving/packages/KOSPI_BULL', 'APPROVED', TRUE, FALSE, '2026-05-31 lab handoff: visible package shell only; runtime/live orders disabled.', 100000000, 0.0),
('KOSDAQ_BULL', 'KOSDAQ Bull v1', '1.0.0', '상승장', 'KOSDAQ 전용 상승장 paper-runtime 후보 패키지입니다.', 'domains/quant-serving/packages/KOSDAQ_BULL', 'APPROVED', TRUE, FALSE, '2026-05-31 lab handoff: visible package shell only; runtime/live orders disabled.', 100000000, 4.78),
('KOSPI_WATCH', 'KOSPI Watch', '0.1.0', '기타', 'KOSPI 실시간 regime/watch paper-shadow 모니터 패키지입니다.', 'domains/quant-serving/packages/KOSPI_WATCH', 'APPROVED', TRUE, FALSE, '2026-05-31 lab handoff: visible package shell only; monitor does not trade.', 100000000, 0.0),
('KOSDAQ_WATCH', 'KOSDAQ Watch', '0.1.0', '기타', 'KOSDAQ 실시간 regime/watch paper-shadow 모니터 패키지입니다.', 'domains/quant-serving/packages/KOSDAQ_WATCH', 'APPROVED', TRUE, FALSE, '2026-05-31 lab handoff: visible package shell only; monitor does not trade.', 100000000, 0.0)
